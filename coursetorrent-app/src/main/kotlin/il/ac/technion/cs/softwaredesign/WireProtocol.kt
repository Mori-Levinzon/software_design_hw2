...
object WireProtocolDecoder {
     ...
     */
    fun decode(message: ByteArray, numOfInts: Int): DecodedMessage {
        ...
        return DecodedMessage(length, messageId, ints, contents)
    }

    fun handshake(message: ByteArray): DecodedHandshake {
